...
/*
 Filtra solo para los elementos de la matriz determinada que pasan la prueba implementada por la función proporcionada.
 */

 const filterProducts = products.filter(product => product.id !== 5);
